...
SubscriptionModel subscriptionModelFromMap(String str) =>
    SubscriptionModel.fromMap(json.decode(str));

String subscriptionModelToMap(SubscriptionModel data) =>
